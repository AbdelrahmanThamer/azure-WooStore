...
abstract class ModelUtils {
  ...
  static List<T> createListOfType<T>(dynamic listOfMaps,
  ...
  static Set<T> createSetOfType<T>(dynamic listOfMaps,
      T Function(Map<String, dynamic> elem) mappingFunction,) {
    try {
      if (listOfMaps == null || listOfMaps is! List) {
        return const {};
  ...
  static Map<T1, T2> createMapOfType<T1, T2>(dynamic value,
